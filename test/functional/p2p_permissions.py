...
class P2PPermissionsTests(PocketcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].pocketcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].pocketcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
