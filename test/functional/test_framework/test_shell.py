...
class TestShell:
    """Wrapper Class for PocketcoinTestFramework.

    The TestShell class extends the PocketcoinTestFramework
    ...
    class __TestShell(PocketcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by PocketcoinTestFramework child class.
            self.num_nodes = 1
