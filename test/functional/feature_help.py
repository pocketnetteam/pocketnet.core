...
"""Verify that starting pocketcoin with -h works as expected."""

from test_framework.test_framework import PocketcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(PocketcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pocketcoin with -h for help text")
        ...
        self.log.info("Start pocketcoin with -version for version information")
        ...
        self.log.info("Start pocketcoind with -fakearg to make sure it does not start")
