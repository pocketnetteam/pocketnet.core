...
* pocketcoin.conf: contains configuration settings for pocketcoind or pocketcoin-qt
* pocketcoind.pid: stores the process id of pocketcoind while running
...
* debug.log: contains debug information and general logging generated by pocketcoind or pocketcoin-qt
