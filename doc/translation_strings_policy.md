...
This document provides guidelines for internationalization of the Pocketcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `pocketcoin_en.ts` remains unchanged.
