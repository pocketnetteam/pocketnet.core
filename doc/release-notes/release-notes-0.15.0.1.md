Pocketcoin Core version *0.15.0.1* is now available from:

  <https://pocketcoin.org/bin/pocketcoin-core-0.15.0.1/>

and

  <https://pocketcoincore.org/bin/pocketcoin-core-0.15.0.1/>
