Download URL: https://sourceforge.net/projects/pocketcoin/files/Pocketcoin/pocketcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 POC fee schedule (users still pay 0.01 POC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #pocketcoin00 - #pocketcoin99
