Pocketcoin Core version 0.9.4 is now available from:

  https://pocketcoin.org/bin/0.9.4/
...
this update is incompatible with the Pocketcoin system and could lead to consensus
forks.

Pocketcoin Core released binaries from https://pocketcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~pocketcoin/+archive/ubuntu/pocketcoin
- A third-party or self-compiled Pocketcoin Core

upgrade to Pocketcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
