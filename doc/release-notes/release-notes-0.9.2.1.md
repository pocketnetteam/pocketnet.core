Pocketcoin Core version 0.9.2.1 is now available from:

  https://pocketcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 POC to 0.01 POC
...
- Fix "Start pocketcoin on system login"
