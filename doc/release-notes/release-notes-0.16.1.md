Pocketcoin Core version 0.16.1 is now available from:

  <https://pocketcoincore.org/bin/pocketcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting pocketcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure pocketcoind processes are cleaned up when tests end (sdaftuar)
