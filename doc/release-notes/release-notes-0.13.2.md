Pocketcoin Core version 0.13.2 is now available from:

  <https://pocketcoin.org/bin/pocketcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update pocketcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow pocketcoin-tx to create v2 transactions (btcdrak)
