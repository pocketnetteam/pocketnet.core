Pocketcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/pocketcoin/files/Pocketcoin/pocketcoin-0.5.4/
...
http://gitorious.org/pocketcoin/pocketcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Pocketcoin-Qt notifications under Growl 1.3.
Increase required age of Pocketcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPocketcoin properly when installing Pocketcoin-Qt over it. (Windows)
