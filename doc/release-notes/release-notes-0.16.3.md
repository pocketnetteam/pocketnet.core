Pocketcoin Core version 0.16.3 is now available from:

  <https://pocketcoincore.org/bin/pocketcoin-core-0.16.3/>
...
been discovered in Pocketcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` pocketcoinconsensus: invalid flags error should be set to `pocketcoinconsensus_err` (afk11)
