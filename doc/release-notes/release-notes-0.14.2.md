Pocketcoin Core version 0.14.2 is now available from:

  <https://pocketcoin.org/bin/pocketcoin-core-0.14.2/>
...
(in Pocketcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Pocketcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate pocketcoin-config.h as necessary (theuni)
