Pocketcoin Core version 0.10.4 is now available from:

  <https://pocketcoin.org/bin/pocketcoin-core-0.10.4/>
...
- #6953 `43c2789` Split pocketcoin-tx into its own package
- #6953 `dfe0d4d` Include pocketcoin-tx binary on Debian/Ubuntu
