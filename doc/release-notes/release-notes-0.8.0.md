Pocketcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/pocketcoin/files/Pocketcoin/pocketcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Pocketcoin
...
New/changed settings (command-line or pocketcoin.conf file)
--------------------------------------------------------
