...
bool GenerateOuts(CAmount nCredit, std::vector<CTxOut> &results, CAmount &totalAmount, std::vector<std::string> winners,
    opcodetype op_code_type, int height, std::vector<opcodetype> &winner_types)
{
