...
std::string PSBTOperationsDialog::renderTransaction(const PartiallySignedTransaction &psbtx)
{
    ...
    for (const CTxOut& out : psbtx.tx->vout) {
        ...
        tx_description.append(tr(" * Sends %1 to %2")
            .arg(PocketcoinUnits::formatWithUnit(PocketcoinUnits::POC, out.nValue))
    ...
    if (!*analysis.fee) {
        ...
        tx_description.append(PocketcoinUnits::formatWithUnit(PocketcoinUnits::POC, *analysis.fee));
