...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("fDisableNotifications"))
        settings.setValue("fDisableNotifications", false);
    fDisableNotifications = settings.value("fDisableNotifications").toBool();

    // Display
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", PocketcoinUnits::PKOIN);
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case MinimizeOnClose:
            ...
            break;
        case DisableNotifications:
            fDisableNotifications = value.toBool();
            settings.setValue("fDisableNotifications", fDisableNotifications);
            break;
...
void OptionsModel::checkAndMigrate()
{
    ...
    if (settingsVersion < CLIENT_VERSION)
    {
        ...
        // see https://github.com/pocketcoin/pocketcoin/pull/8273
