...
//
//     src/qt/test/test_pocketcoin-qt -platform xcb      # Linux
//     src/qt/test/test_pocketcoin-qt -platform windows  # Windows
//     src/qt/test/test_pocketcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = PocketcoinUnits::formatWithUnit(unit, balance, false, PocketcoinUnits::separatorAlways);
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: pocketcoin:")) != -1);
