...
//! Entry point for PocketcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &PocketcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for PocketcoinGUI tests.
void AppTests::guiTests(PocketcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &PocketcoinGUI::consoleShown, this, &AppTests::consoleTests);
