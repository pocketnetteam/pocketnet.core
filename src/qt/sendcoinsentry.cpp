    ...
    platformStyle(_platformStyle)
{
    ...
    // normal pocketcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying pocketcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &PocketcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
