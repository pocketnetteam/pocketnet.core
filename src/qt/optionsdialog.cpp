...
{
    /* Main */
    mapper->addMapping(ui->pocketcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openPocketcoinConfButton_clicked()
{
