    ...
    QWidget(parent)
{
    ...
    typeWidget->addItem(tr("CoinStake"), TransactionFilterProxy::TYPE(TransactionRecord::CoinStake));
...
void TransactionView::changedAmount()
{
    ...
    if (PocketcoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amountWidget->text(), &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(PocketcoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
