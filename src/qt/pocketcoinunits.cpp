...
bool PocketcoinUnits::valid(int unit)
{
    switch(unit)
    {
    case PKOIN:
...
QString PocketcoinUnits::longName(int unit)
{
    switch(unit)
    {
...
QString PocketcoinUnits::shortName(int unit)
{
    switch(unit)
    {
...
QString PocketcoinUnits::description(int unit)
{
    switch(unit)
    {
...
qint64 PocketcoinUnits::factor(int unit)
{
    switch(unit)
    {
...
int PocketcoinUnits::decimals(int unit)
{
    switch(unit)
    {
    case PKOIN: return 8;
...
QString PocketcoinUnits::formatWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
    return format(unit, amount, plussign, separators) + QString(" ") + shortName(unit);
}

QString PocketcoinUnits::formatHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators)
{
...
QString PocketcoinUnits::getAmountColumnTitle(int unit)
{
    QString amountTitle = QObject::tr("Amount");
    if (PocketcoinUnits::valid(unit))
    {
        amountTitle += " ("+PocketcoinUnits::shortName(unit) + ")";
    }
    return amountTitle;
}

int PocketcoinUnits::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
    return unitlist.size();
}

QVariant PocketcoinUnits::data(const QModelIndex &index, int role) const
{
    int row = index.row();
...
CAmount PocketcoinUnits::maxMoney()
{
    return MAX_MONEY;
}
