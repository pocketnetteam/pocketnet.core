...
public:
    CMainParams()
    {
        ...
        consensus.CSVHeight = 419328; // 000000000000000004a1b34462cb8aeebd5799177f7a29cf28f2d1961716b5b5 // TODO (brangr): these values are changed from time to height, need to investigate them from very beginning. See other "TODO (losty): " in this file for same.
