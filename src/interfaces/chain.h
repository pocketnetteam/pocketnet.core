...
#ifndef POCKETCOIN_INTERFACES_CHAIN_H
#define POCKETCOIN_INTERFACES_CHAIN_H
...
//! internal workings of the pocketcoin node, and not being very convenient to use.
...
#endif // POCKETCOIN_INTERFACES_CHAIN_H
