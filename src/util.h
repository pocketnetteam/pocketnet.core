 ...
 */
#ifndef POCKETCOIN_UTIL_H
#define POCKETCOIN_UTIL_H
...
extern const char * const POCKETCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("pocketcoin-%s", name);
