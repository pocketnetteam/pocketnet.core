...
#endif
#if defined(HAVE_GETENTROPY) || (defined(HAVE_GETENTROPY_RAND) && defined(__APPLE__))
#include <unistd.h>
#endif
...
static void SeedPeriodic(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrintCategory(BCLog::RAND, "Feeding %i bytes of dynamic environment data into RNG\n", hasher.Size() - old_size);
...
static void SeedStartup(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrintCategory(BCLog::RAND, "Feeding %i bytes of environment data into RNG\n", hasher.Size() - old_size);
