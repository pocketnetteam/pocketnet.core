...
#ifndef POCKETCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define POCKETCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Pocketcoin Core wallet was originally a collection of unrelated private
...
#endif // POCKETCOIN_WALLET_SCRIPTPUBKEYMAN_H
