...
if(BerkeleyDB_INCLUDE_DIRS)
	...
	if(BerkeleyDB_FIND_REQUIRED)
		...
		message(FATAL_ERROR "Failed to find Berkeley DB's header file \"db.h\"! Try setting \"BDB_ROOT\" when initiating Cmake.")
	elseif(NOT BerkeleyDB_FIND_QUIETLY)
		message(WARNING "Failed to find Berkeley DB's header file \"db.h\"! Try setting \"BDB_ROOT\" when initiating Cmake.")
	endif()
