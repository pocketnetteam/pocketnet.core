...
static RPCHelpMan validateaddress()
{
    return RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The pocketcoin address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static RPCHelpMan verifymessage()
{
    return RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The pocketcoin address to use for the signature."},
...
static RPCHelpMan logging()
{
    return RPCHelpMan{"logging",
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    int64_t original_log_categories = LogInstance().GetCategoryMask();
    ...
    int64_t updated_log_categories = LogInstance().GetCategoryMask();
    int64_t changed_log_categories = original_log_categories ^ updated_log_categories;
