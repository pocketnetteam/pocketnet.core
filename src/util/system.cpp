...
const char * const POCKETCOIN_SETTINGS_FILENAME = "settings.json"; // TODO (losty-fur) do not forget about this
...
bool ArgsManager::GetSettingsPath(fs::path* filepath, bool temp) const
{
    ...
    if (filepath) {
        std::string settings = GetArg("-settings", POCKETCOIN_SETTINGS_FILENAME);
