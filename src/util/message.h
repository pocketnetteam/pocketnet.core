...
#ifndef POCKETCOIN_UTIL_MESSAGE_H
#define POCKETCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's pocketcoin address, it must refer to a public key.
...
#endif // POCKETCOIN_UTIL_MESSAGE_H
