...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-collectstat", strprintf("Allow statistics to be collected in memory (default: false)", false), ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::DEBUG_TEST);
