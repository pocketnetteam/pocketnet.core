...
void SetupServerArgs(NodeContext& node)
{
    ...
    argsman.AddArg("-mempoolclean", "Clean mempool on loading and delete or non blocked transactions from sqlite db (Default: 1)", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
