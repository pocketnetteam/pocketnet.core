...
#ifndef POCKETCOIN_COMPAT_ENDIAN_H
#define POCKETCOIN_COMPAT_ENDIAN_H
...
// systems to build things like libpocketcoinconsensus for strange targets.
#ifdef htobe16
...
#endif // POCKETCOIN_COMPAT_ENDIAN_H
