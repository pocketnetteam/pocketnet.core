...
private:
    ...
    bool check_post_edit(UniValue oitm, BlockVTX& blockVtx, bool checkMempool, bool checkWithTime, int height, ANTIBOTRESULT& result);
...
public:
    ...
    bool CheckRegistration(UniValue oitm, std::string address, bool checkMempool, bool checkWithTime, BlockVTX& blockVtx, ANTIBOTRESULT& result);
