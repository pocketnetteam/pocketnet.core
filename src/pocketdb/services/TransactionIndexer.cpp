...
{
    void TransactionIndexer::Index(const CBlock& block, int height)
    {
    ...
    bool TransactionIndexer::Rollback(int height)
    {
        return PocketDb::ChainRepoInst.Rollback(height);
    }

    void TransactionIndexer::PrepareTransactions(const CBlock& block, vector <TransactionIndexingInfo>& txs)
    {
    ...
    void TransactionIndexer::IndexChain(const string& blockHash, int height, vector <TransactionIndexingInfo>& txs)
    {
        PocketDb::ChainRepoInst.IndexBlock(blockHash, height, txs);
    }

    void TransactionIndexer::IndexRatings(int height, const CBlock& block)
    {
    ...
    void TransactionIndexer::BuildAccountLikers(const shared_ptr <ScoreDataDto>& scoreData, map<int, vector<int>>& accountLikers)
    {
        auto found = find(
