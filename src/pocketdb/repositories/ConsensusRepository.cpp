...
namespace PocketDb
{
    ...
    void ConsensusRepository::AddBadge(int height, const string& address, const string& txHash, BadgeType destBadgeType, BadgeType sourceBadgeType, const vector<string>& developers)
    {
        SqlTransaction(__func__, [&]()
        {
            Sql(R"sql(
    ...
    void ConsensusRepository::RemoveBadge(int height, const string& address, const string& txHash, BadgeType destBadgeType, BadgeType sourceBadgeType, const vector<string>& developers)
    {
        SqlTransaction(__func__, [&]()
        {
            Sql(R"sql(
