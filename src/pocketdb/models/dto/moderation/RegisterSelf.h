...
namespace PocketTx
{
    class ModerationRegisterSelf : public ModerationRegister
    {
    public:
        ModerationRegisterSelf();
        ModerationRegisterSelf(const CTransactionRef& tx);
    }; // class ModerationRegisterSelf
