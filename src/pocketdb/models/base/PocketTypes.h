...
namespace PocketTx
{
    ...
    enum RatingType
    {
        ...
        ACCOUNT_LIKERS_POST = 11,
        ACCOUNT_LIKERS_POST_COUNT = 101,
        ACCOUNT_LIKERS_COMMENT_ROOT = 12,
        ACCOUNT_LIKERS_COMMENT_ROOT_COUNT = 102,
        ACCOUNT_LIKERS_COMMENT_ANSWER = 13,
        ACCOUNT_LIKERS_COMMENT_ANSWER_COUNT = 103,

        ACCOUNT_DISLIKERS_COMMENT_ANSWER = 14,
        ACCOUNT_DISLIKERS_COMMENT_ANSWER_COUNT = 104,
    };
