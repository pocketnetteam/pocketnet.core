...
namespace PocketConsensus
{
    ...
    enum ConsensusLimit
    {
        ...
        ConsensusLimit_trial_barteron_offer,
        ConsensusLimit_trial_barteron_request,
        ...
        ConsensusLimit_full_barteron_offer,
        ConsensusLimit_full_barteron_request,
        ...
        ConsensusLimit_barteron_offer_edit_count,
        ConsensusLimit_barteron_request_edit_count,
        ...
        ConsensusLimit_edit_barteron_offer_depth,
        ConsensusLimit_edit_barteron_request_depth,
        ...
        ConsensusLimit_max_barteron_offer_size,
        ConsensusLimit_max_barteron_request_size,
