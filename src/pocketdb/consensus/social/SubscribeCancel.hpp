...
namespace PocketConsensus
{
    ...
    *******************************************************************************************************************/
    ...
    public:
        ...
        {
            return Validate(static_pointer_cast<SubscribeCancel>(tx), block);
        }

        tuple<bool, SocialConsensusResult> Check(shared_ptr<Transaction> tx) override
        {
            return Check(static_pointer_cast<SubscribeCancel>(tx));
        }
    protected:
        tuple<bool, SocialConsensusResult> Validate(shared_ptr<SubscribeCancel> tx, PocketBlock& block)
        {
