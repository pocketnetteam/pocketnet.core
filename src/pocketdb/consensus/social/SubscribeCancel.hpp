    ...
    *******************************************************************************************************************/
    ...
    public:
        ...
        tuple<bool, SocialConsensusResult> Validate(shared_ptr<Transaction> tx, PocketBlock& block) override
        {
            ...
            if (auto[ok, result] = Validate(static_pointer_cast<SubscribeCancel>(tx), block); !ok)
                return make_tuple(false, result);
        ...
        tuple<bool, SocialConsensusResult> Check(shared_ptr<Transaction> tx) override
        {
            ...
            if (auto[ok, result] = Check(static_pointer_cast<SubscribeCancel>(tx)); !ok)
                return make_tuple(false, result);
    ...
    protected:
        ...
        virtual tuple<bool, SocialConsensusResult> Validate(shared_ptr<SubscribeCancel> tx, PocketBlock& block)
        {
            ...
            {
                return make_tuple(false, SocialConsensusResult_InvalideSubscribe);
            }
    ...
    private:
        ...
        tuple<bool, SocialConsensusResult> Check(shared_ptr<SubscribeCancel> tx)
        {
