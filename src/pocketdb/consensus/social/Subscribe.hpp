...
namespace PocketConsensus
{
    ...
    *******************************************************************************************************************/
    ...
    public:
        ...
        {
            return Validate(static_pointer_cast<Subscribe>(tx), block);
        }

        tuple<bool, SocialConsensusResult> Check(shared_ptr<Transaction> tx) override
        {
            return Check(static_pointer_cast<Subscribe>(tx));
        }
    protected:
        tuple<bool, SocialConsensusResult> Validate(shared_ptr<Subscribe> tx, PocketBlock& block)
        {
