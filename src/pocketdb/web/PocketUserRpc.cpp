...
std::map<std::string, UniValue> PocketWeb::PocketUserRpc::GetUsersProfiles(const DbConnectionRef& dbCon, std::vector<std::string> addresses, bool shortForm, int option)
{
