...
UniValue PocketWeb::PocketScoresRpc::GetAddressScores(const JSONRPCRequest& request)
{
//    if (request.fHelp)
...
//----------------------------------------------------------
UniValue PocketWeb::PocketScoresRpc::GetPostScores(const JSONRPCRequest& request)
{
