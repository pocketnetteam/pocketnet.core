...
static const CRPCCommand commands[] =
{
    ...
    {"contents",        "getdiscussedfeed",                 &GetDiscussedFeed,              {"topHeight","topContentHash","countOut","lang","tags","contentTypes","txIdsExcluded","adrsExcluded","tagsExcluded","address","depth"}},
