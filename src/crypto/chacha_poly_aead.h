...
#ifndef POCKETCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define POCKETCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@pocketcoin.
 *
 ...
 *
 * The chacha20-poly1305@pocketcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@pocketcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@pocketcoin are relatively fast in
...
#endif // POCKETCOIN_CRYPTO_CHACHA_POLY_AEAD_H
