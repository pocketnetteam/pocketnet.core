...
WebRTCConnection::WebRTCConnection(std::string ip, std::weak_ptr<ProtectedMap<std::string, std::shared_ptr<WebRTCConnection>>> container, std::shared_ptr<Queue<std::shared_ptr<WebRTCConnection>>> clearer, std::shared_ptr<rtc::PeerConnection> pc)
    : m_ip(std::move(ip)),
