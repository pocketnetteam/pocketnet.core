...
#ifndef POCKETCOIN_KEYSTORE_H
#define POCKETCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/pocketcoin/bips/blob/master/bip-0013.mediawiki
