...
// pocketcoin includes.
#include <..\src\script\pocketcoinconsensus.h>
...
int main()
{
    std::cout << "pocketcoinconsensus version: " << pocketcoinconsensus_version() << std::endl;
    ...
    auto op0Result = pocketcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, pocketcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
