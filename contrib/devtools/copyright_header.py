#!/usr/bin/env python3
# Copyright (c) 2016-2021 The Pocketcoin Core developers
...
EXCLUDE = [
    ...
    'src/secp256k1/src/java/org_pocketcoin_NativeSecp256k1.c',
    'src/secp256k1/src/java/org_pocketcoin_NativeSecp256k1.h',
    'src/secp256k1/src/java/org_pocketcoin_Secp256k1Context.c',
    'src/secp256k1/src/java/org_pocketcoin_Secp256k1Context.h',
    # univalue:
...
Arguments:
    <base_directory> - The base directory of a pocketcoin source code repository.
...
Arguments:
    <file> - A source file in the pocketcoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Pocketcoin
